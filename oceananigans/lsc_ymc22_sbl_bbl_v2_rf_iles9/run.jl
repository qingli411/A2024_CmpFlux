...
simulation = Simulation(model, Δt=10.0, stop_time=288hours)
...
simulation.output_writers[:averages] =
    JLD2OutputWriter(model, (u=U, v=V, b=b, wb=wb, wu=wu, wv=wv, ww=ww, uu=uu, vv=vv, uv=uv, w3=w3, bb=bb,
                             Cs=Cs, wCs=wCs, Cb=Cb, wCb=wCb),
